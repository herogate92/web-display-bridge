...
export interface HostApi {
  ...
  stop(identity?: string): Promise<void>; recover(): Promise<void>; configureMonitorCount(count: number): Promise<void>;
  ...
  installCustomMode(width: number, height: number, fps: number): Promise<void>;
  help(): Promise<void>;
}
